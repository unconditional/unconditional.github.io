        ...
        calc: function (update) {
            ...
            switch (this.target) {
                case "base":
                    ...
                    this.coords.p_mark_single = this.coords.p_single;
                    this.coords.p_mark_from = this.coords.p_from;
                    this.coords.p_mark_to = this.coords.p_to;
        ...
        drawMark: function () {
            ...
            if (o.type === "single") {
                if (o.from_mark) {
                    ...
                    // console.debug("drawMark: slider = %o", this.$cache.s_single);
                    
                    console.debug("drawMark: this.coords = %o", this.coords);
                
                    // slider = c.s_single[0];
                    
                    // console.debug("slider.style = %o", slider.style);
                    
                    c.mark_single[0].style.display = "block";
                    // c.mark_single[0].style.left = (slider.style.left + slider.style.width / 2) + "%";
                    
                    c.mark_single[0].style.left = this.coords.p_single + (this.coords.p_handle / 2) + "%"; // p_from
                    
                    console.debug("drawMark: mark_single[0] = %o", c.mark_single[0]);
                } else {
            ...
            /*else {
                if (o.from_shadow && (is_from_min || is_from_max)) {
                    ...
                    c.mark_from[0].style.left = from_min + "%";
                    c.mark_from[0].style.width = from_max + "%";
                } else {
                ...
                if (o.to_shadow && (is_to_min || is_to_max)) {
                    ...
                    c.mark_to[0].style.left = to_min + "%";
                    c.mark_to[0].style.width = to_max + "%";
                } else {
