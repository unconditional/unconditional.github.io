    ...
    IonRangeSlider.prototype = {
        ...
        calc: function (update) {
            ...
            switch (this.target) {
                case "base":
                    ...
                    // this.coords.p_mark_single = this.coords.p_single_real;
                    // this.coords.p_mark_from = this.coords.p_from_real;
                    // this.coords.p_mark_to = this.coords.p_to_real;
        ...
        drawHandles: function () {
            ...
            if (this.coords.w_rs !== this.coords.w_rs_old || this.force_redraw) {
                ...
                console.debug("update: this.coords = %o", this.coords);
            }
        ...
        drawMark: function () {
            ...
            if (o.type === "single") {
                if (o.from_mark) {
                    ...
                    c.mark_single[0].style.left = this.coords.p_single + (this.coords.p_handle / 2) + "%";
                ...
                if (o.from_mark) {
                    ...
                    c.mark_from[0].style.left = this.coords.p_from + (this.coords.p_handle / 2) + "%";
                    
                    console.debug("drawMark: mark_from[0] = %o", c.mark_from[0]);
                } else {
                ...
                if (o.to_mark) {
                    ...
                    c.mark_to[0].style.left = this.coords.p_to + (this.coords.p_handle / 2) + "%";
                    
                    console.debug("drawMark: mark_to[0] = %o", c.mark_to[0]);
                } else {
